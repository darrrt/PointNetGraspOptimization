...
class AdamGrasp:
    ...
    def run_adam(self, object_name, contact_map_goal, running_name,q_joint_suggest=None,q_rot_suggest=None):
        q_trajectory = []
        self.opt_model.reset(contact_map_goal, running_name, self.energy_func_name,q_joint_suggest,q_rot_suggest)
        with torch.no_grad():
